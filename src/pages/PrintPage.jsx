...
function PrintPage() {
  ...
  >
    <div className="w-full max-w-screen-md mx-auto flex flex-col items-center justify-center px-4 md:px-8 py-4 md:py-8">
      <h1 className="font-bold text-xl md:text-4xl text-center mb-4 md:mb-8 text-white text-shadow-2xs">Objednávka tisknutých kartiček</h1>
      <p className="text-base md:text-2xl text-center mb-4 max-w-lg text-white text-shadow-2xs">
        Nabízíme možnost objednat si kartičky ve vysoké kvalitě, vytištěné na tvrdý papír a zalaminované pro delší životnost.
      </p>
      <p className="text-base md:text-xl text-center mb-4 max-w-md text-white text-shadow-2xs">
      ...
      <p className="text-base md:text-xl text-center max-w-md text-white text-shadow-2xs">
